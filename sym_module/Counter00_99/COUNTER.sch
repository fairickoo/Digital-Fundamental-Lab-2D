...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="OUT_1_2" />
        <signal name="OUT_1_3" />
        <signal name="OUT_10_0" />
        <signal name="OUT_10_1" />
        <signal name="OUT_10_2" />
        <signal name="OUT_10_3" />
        <port polarity="Input" name="CLK_IN" />
        <port polarity="Input" name="CLR" />
        <port polarity="Output" name="OUT_1_0" />
        <port polarity="Output" name="OUT_1_1" />
        <port polarity="Output" name="OUT_1_2" />
        <port polarity="Output" name="OUT_1_3" />
        <port polarity="Output" name="OUT_10_0" />
        <port polarity="Output" name="OUT_10_1" />
        <port polarity="Output" name="OUT_10_2" />
        <port polarity="Output" name="OUT_10_3" />
        <blockdef name="cd4ce">
        ...
        <block symbolname="cd4ce" name="XLXI_1">
            ...
            <blockpin signalname="OUT_1_0" name="Q0" />
            <blockpin signalname="OUT_1_1" name="Q1" />
            <blockpin signalname="OUT_1_2" name="Q2" />
            <blockpin signalname="OUT_1_3" name="Q3" />
            <blockpin name="TC" />
        </block>
        <block symbolname="cd4ce" name="XLXI_2">
            ...
            <blockpin name="CEO" />
            <blockpin signalname="OUT_10_0" name="Q0" />
            <blockpin signalname="OUT_10_1" name="Q1" />
            <blockpin signalname="OUT_10_2" name="Q2" />
            <blockpin signalname="OUT_10_3" name="Q3" />
            <blockpin name="TC" />
        </block>
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="OUT_10_0">
            <wire x2="2288" y1="1088" y2="1088" x1="2256" />
        </branch>
        <iomarker fontsize="28" x="2288" y="1088" name="OUT_10_0" orien="R0" />
        <branch name="OUT_10_1">
            <wire x2="2288" y1="1152" y2="1152" x1="2256" />
        </branch>
        <iomarker fontsize="28" x="2288" y="1152" name="OUT_10_1" orien="R0" />
        <branch name="OUT_10_2">
            <wire x2="2288" y1="1216" y2="1216" x1="2256" />
        </branch>
        <iomarker fontsize="28" x="2288" y="1216" name="OUT_10_2" orien="R0" />
        <branch name="OUT_10_3">
            <wire x2="2288" y1="1280" y2="1280" x1="2256" />
        </branch>
        <iomarker fontsize="28" x="2288" y="1280" name="OUT_10_3" orien="R0" />
        <iomarker fontsize="28" x="2288" y="928" name="OUT_1_3" orien="R0" />
        <iomarker fontsize="28" x="2288" y="848" name="OUT_1_2" orien="R0" />
        <iomarker fontsize="28" x="2288" y="768" name="OUT_1_1" orien="R0" />
        <iomarker fontsize="28" x="2288" y="704" name="OUT_1_0" orien="R0" />
    </sheet>
</drawing>